...
# avoiding 2-d arrays
template_apps=(core interactive_visualization single_quiz manual_news_article_curation core core)
template_names=(feed_item.html feed_item.html feed_item.html feed_item.html portal_ux/tag_remove.html portal_ux/jumbotron_feedback.html)
